  ...
  return (
    <div className=' '>
      <div className= 'absolute bg-white rounded-md z-50 top-32 left-10 right-10 shadow-white shadow-md '>
        ...
        <label htmlFor="name" className='flex flex-col mb-2 '> Name
        <input type='text' onChange={formik.handleChange} value={formik.values.name} name="name" id="name"  className='border-2 border-black shadow-md rounded-sm pl-4 p-1'>
            </input> 
        </label>
           
        <label htmlFor = "email" className='flex flex-col mb-4'>Email
        <input type='Email' onChange={formik.handleChange} value={formik.values.email} name="email" id="email"  className='border-2 border-black rounded-sm pl-4 p-1 shadow-md
        '></input>
        </label>
      ...
      <div className='backdrop-blur h-full w-full absolute top-0 bottom-0 opacity-80 right-0'>
